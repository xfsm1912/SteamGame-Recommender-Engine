...
engine = sqlalchemy.create_engine('mysql+pymysql://root:xfsm220@stocking@localhost:3306/game_recommendation?charset=utf8mb4&local_infile=1') # replace <> parts in the string
